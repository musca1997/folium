...
type CliOptions = { json: boolean; wait: boolean; public: boolean; private: boolean; text: boolean };
...
function parseArgs(argv: string[]) {
  ...
  const opts: CliOptions = { json: false, wait: false, public: false, private: false, text: false };
  const args: string[] = [];
