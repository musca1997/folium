...
export const lccCanonicalTopics: LccCanonicalTopic[] = [
  ...
  { code: "B", name: "Philosophy, Psychology, Religion", slug: "philosophy-psychology-religion", description: "Library of Congress class B: philosophy, psychology, religion, ethics, and related traditions.", aliases: ["philosophy", "psychology", "religion", "ethics", "metaphysics", "epistemology", "phenomenology", "future studies", "eschatology"], externalUrl: LCC_OUTLINE_URL },
  ...
  { code: "M", name: "Music", slug: "music", description: "Library of Congress class M: music, musicology, instruments, composition, and music culture.", aliases: ["music", "musicology", "music and musicology", "musical", "composer", "song", "songs", "instrument", "electronic music", "k-pop", "sound art"], externalUrl: LCC_OUTLINE_URL },
  { code: "N", name: "Fine Arts", slug: "fine-arts", description: "Library of Congress class N: visual arts, fine arts, design, architecture, images, and art history.", aliases: ["art", "fine arts", "visual culture", "visual research", "design", "typography", "photography", "painting", "architecture", "aesthetics", "graphic design", "artist publishing", "printmaking", "screen printing", "ai creativity tools"], externalUrl: LCC_OUTLINE_URL },
  ...
  { code: "T", name: "Technology", slug: "technology", description: "Library of Congress class T: technology, engineering, electronics, manufacturing, infrastructure, and applied technical systems.", aliases: ["technology", "engineering", "electronics", "hardware", "software development", "programming", "cybersecurity", "self-hosting", "wireless communication", "lora", "meshtastic", "embedded systems", "industrial design", "retro computing", "homebrew app", "creative coding", "audio visualization"], externalUrl: LCC_OUTLINE_URL },
