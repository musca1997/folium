        ...
        <section className="mb-8 border-b border-line pb-8">
          ...
          <div className="mt-8 grid gap-3 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-center">
            <form className="flex gap-2" action="/search">
              <input name="q" placeholder="Search saved pages, summaries, topics, nodes..." className="min-w-0 flex-1 border border-line px-3 py-2 text-sm outline-none focus:border-ink" />
